...
def main():
    ...
    test_sents = load_conllu(os.path.join(RAW_DIR, "tr_imst-ud-test.conllu"))
    # dev'i eğitime dahil et (daha fazla veri)
    all_train_sents = train_sents + dev_sents
    print(f"  Eğitim cümlesi: {len(all_train_sents)} | Test cümlesi: {len(test_sents)}")
